...
import com.taskflow.sporttracker.mapper.WorkoutExerciseMapper;
import com.taskflow.sporttracker.repository.ExerciseRepository;
import com.taskflow.sporttracker.repository.WorkoutExerciseRepository;
...
public class WorkoutExerciseService {
    ...
    public WorkoutExerciseListResponse addWorkoutExerciseById(
        ...
        var exercise = exerciseRepository.findByIdAndAvailableForUser(workoutExerciseCreateRequest.exerciseId(), email)
                .orElseThrow(() -> new NotFoundException(
                        "Exercise not found with id: " + workoutExerciseCreateRequest.exerciseId()));
